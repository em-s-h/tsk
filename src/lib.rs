// use crate::cli::Cli;
// use crate::task_file::AddPosition;
...
// // Operations {{{
//
// fn add_task(task_f: &PathBuf, task: &str, place: &AddPosition) {
//     // {{{
//     println!("Adding task...");
//
//     if *place == AddPosition::Top {
//         operate_task_file(
//             &task_f,
...
//
//         add_task(&f, &task, &AddPosition::Top);
...
//
//         add_task(&f, &task, &AddPosition::Bottom);
//         let task = format!("[ ] {task}");
//
//         let f = File::open(&f).unwrap_or_else(|e| {
//             eprintln!("Unable to open file");
